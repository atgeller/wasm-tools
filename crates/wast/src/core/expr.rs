...
instructions! {
    pub enum Instruction<'a> {
        ...
        I32Load16uPrecheck(MemArg<2>) : [0xfa, 0x2f] : "i32.load16_u_prechk",
        I64Load8sPrecheck(MemArg<1>) : [0xfa, 0x30] : "i64.load8_s_prechk",
        I64Load8uPrecheck(MemArg<1>) : [0xfa, 0x31] : "i64.load8_u_prechk",
        I64Load16sPrecheck(MemArg<2>) : [0xfa, 0x32] : "i64.load16_s_prechk",
        I64Load16uPrecheck(MemArg<2>) : [0xfa, 0x33] : "i64.load16_u_prechk",
        I64Load32sPrecheck(MemArg<4>) : [0xfa, 0x34] : "i64.load32_s_prechk",
        ...
        I64Store16Precheck(MemArg<2>) : [0xfa, 0x3d] : "i64.store16_prechk",
        I64Store32Precheck(MemArg<4>) : [0xfa, 0x3e] : "i64.store32_prechk",
