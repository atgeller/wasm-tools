...
macro_rules! for_each_operator {
    ($mac:ident) => {
        $mac! {
            ...
            @precheck I32Load16UPrechk { memarg: $crate::MemArg } => visit_i32_load16_u_prechk
            @precheck I64Load8SPrechk { memarg: $crate::MemArg } => visit_i64_load8_s_prechk
            @precheck I64Load8UPrechk { memarg: $crate::MemArg } => visit_i64_load8_u_prechk
            @precheck I64Load16SPrechk { memarg: $crate::MemArg } => visit_i64_load16_s_prechk
            @precheck I64Load16UPrechk { memarg: $crate::MemArg } => visit_i64_load16_u_prechk
            @precheck I64Load32SPrechk { memarg: $crate::MemArg } => visit_i64_load32_s_prechk
            ...
            @precheck I64Store16Prechk { memarg: $crate::MemArg } => visit_i64_store16_prechk
            @precheck I64Store32Prechk { memarg: $crate::MemArg } => visit_i64_store32_prechk
