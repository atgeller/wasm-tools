...
macro_rules! define_visit {
    ...
    (name I32Load16UPrechk) => ("i32.load16_u_prechk");
    (name I64Load8SPrechk) => ("i64.load8_s_prechk");
    (name I64Load8UPrechk) => ("i64.load8_u_prechk");
    (name I64Load16SPrechk) => ("i64.load16_s_prechk");
    (name I64Load16UPrechk) => ("i64.load16_u_prechk");
    (name I64Load32SPrechk) => ("i64.load32_s_prechk");
    ...
    (name I64Store16Prechk) => ("i64.store16_prechk");
    (name I64Store32Prechk) => ("i64.store32_prechk");
